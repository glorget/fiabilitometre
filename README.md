...
L'élève complète une évaluation de chaque source en dix questions et un score de fiabilité est alors calculé. Il peut être comparé avec le score attribué préalablement par le professeur qui a fourni la source.
...
- Soutien-gorge et cancer du sein (3 publications : INSERM Canal Détox, Miss Mary, AlternativSanté)
- Boissons énergisantes et santé (3 publications : ANSES, blog TPE de lycéens, ELLE.be)

## Origine

Adapté de la ressource **Fiabilitomètre** élaborée par Anne Merlin, professeure de SVT, 
et Mélanie Serret, professeure documentaliste, au lycée Giraux Sannier (Saint-Martin-Boulogne), 
dans le cadre d'un projet TraAM EMI 2025-2026, publiée sur le site de l'académie de Lille :  
